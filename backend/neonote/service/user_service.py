...
from neonote.core.security import get_password_hash, verify_password
from neonote.models import UserCreate, User
from neonote.api.deps import CurrentUser
from neonote.models.user import UpdatePassword, UserUpdate
